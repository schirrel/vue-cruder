<template>
    <div id="app">
        ...
        <!-- <p>Without service</p> -->
        <!-- <Form name="form2" :fields="formFields2" @submit="save" @error="errorSaving"></Form> -->
        ...
        <h2>with actions</h2>
        <hr />
        <List v-if="service" :service="service" :headers="headers" :actions="actions" />
        <hr />
        <h2>with default actions</h2>
        <hr />
        <List v-if="service" :service="service" :headers="headers" use-crud-actions />
    </div>
</template>
